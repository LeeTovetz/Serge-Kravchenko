...
|-------------------------------------------------------------------|-------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [JavaSchool Level Basic](https://github.com/LeeTovetz/Java-Tasks)                            | The course covers the basics of Java, such as Java Core, collections, multithreading, OOP           | Java Core, Advanced Core                                   |
